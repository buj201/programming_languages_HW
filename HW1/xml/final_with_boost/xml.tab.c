...
#endif
/* Tokens.  */
#define OPENINGTAG 258
#define CLOSINGTAG 259
...
{
  "$end", "error", "$undefined", "OPENINGTAG", "CLOSINGTAG", "$accept",
  "prog", "matches", 0
};
#endif
  ...
  switch (yyn)
    {
        case 2:
#line 53 "xml.y"
    {/* Do nothing since correct input handled in main() */;}
    break;

  case 3:
#line 56 "xml.y"
    { tagcompare((yyvsp[(1) - (3)].strval), (yyvsp[(3) - (3)].strval)) ;;}
    break;

  case 4:
#line 57 "xml.y"
    { tagcompare((yyvsp[(1) - (2)].strval), (yyvsp[(2) - (2)].strval)) ;;}
    break;

  case 5:
#line 58 "xml.y"
    { tagcompare((yyvsp[(2) - (3)].strval), (yyvsp[(3) - (3)].strval)) ;;}
    break;

  case 6:
#line 59 "xml.y"
    { tagcompare((yyvsp[(2) - (4)].strval), (yyvsp[(4) - (4)].strval)) ;;}
    break;
